...
In the survey, the first step was to split the respondants between two categories: citizens and 'entrepreneurs' (i.e. active members of a local citizens initiative, social project or social organization). Therefore, in this document we are going to analyze those two groups separately.
...
Then we split the respondants into two group: first the citizens, including those with no active implication in a local citizen's initiative as well as those with casual volonteering, and second, the entrepreneurs (the active members of a local citizen's initiative). 
