...
Our sample frame (i.e. our population of interest) here is the whole population in the Brussels-Capital Region (therefore including all its 19 municipalities).

Note that the respondants were given the possibility to fill the questionnaire in either English, Dutch or French.
...
We can observe that there is a disproportionate share of respondants with a masters degree among both entrepreneurs and citizens. Therefore, the samples are very likely to be biased.
...
We can observe from this plot that the responses to some of the questions are polarized. Overall, it seems that most of the respondants disagree with the statement: **It is relatively easy for citizens to find places where local public issues are collectively debated**.
...
* Overall, it seems that most of the respondants disagree with the statement: **Civic crowdfunding represents a direct threat to public funding of services**;
* Quite interestingly for the purposes of our research, it seems that most of the respondants agree with the statement: **Civic crowdfunding platforms could play a role of intermediary between citizen's initiatives and the local government**.
...
* It seems that most of the respondants agree with the statement: **Face-to-face interactions are necessary for collective action.**
* It seems that most of the respondants agree with the statement: **Citizens would like to participate in debates on local public issues that they care about.**
* It seems that most of the respondants disagree with the statement: **It is relatively easy for citizens to find places where local public issues are collectively debated.**
* It seems that most of the respondants agree with the statement: **I would welcome the possibility for citizens on a crowdfunding platform to express their disagreement about some aspects of the projects they contribute to financially.**
...
* It seems that most of the respondants disagree with the statement: **Civic crowdfunding represents a direct threat to the funding of public goods and services by the local government.**
* Quite interestingly for the validation of the hypothese H2, it seems that most of the respondants agree with the statement: **Civic crowdfunding platforms could play a role of intermediary between citizen’s initiatives and the local government.**
...
We can observe from this plot that there is a possible positive relationship between education and the extent to which respondants agreed with the statement: **The local government is able to identify the projects that are most wanted by citizens**, although this should be confirmed by the statistical modeling that we will perform in the next chapter.
